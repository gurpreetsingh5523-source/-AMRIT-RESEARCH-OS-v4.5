    ...
    def _init_default_skills(self):
        ...
        default_skills = {
            'blood_analysis': Skill(
                ...
                required_modules=['core.medical.blood_analyzer']
            ),
            'dna_analysis': Skill(
                ...
                required_modules=['core.medical.health_advisor']
            ),
            'consanguinity_check': Skill(
                ...
                required_modules=['core.medical.consanguinity_drug']
            ),
            ...
            'autonomous_research': Skill(
                ...
                required_modules=['core.autonomous.unified_agent']
            ),
            'ethics_check': Skill(
                ...
                required_modules=['core.ethics.ethics_filter']
            ),
            ...
            'team_configuration': Skill(
                ...
                required_modules=['core.agents.harness_teams']
            ),
            'paper_generation': Skill(
                ...
                required_modules=['core.paper_writer.paper_writer']
            ),
            'knowledge_query': Skill(
                ...
                required_modules=['core.knowledge_graph.knowledge_graph']
            ),
            'statistical_analysis': Skill(
                ...
                required_modules=['core.statistics.statistical_engine']
            )
        }
